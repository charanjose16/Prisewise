    ...
    <div className="maindiv">
      ...
      <div className="container-fluid category">
        <div className="row">
          ...
          <Link to={'/viewall'} className="col-1">
      ...
      <div className="container-fluid category">
        <div className="row">
          ...
          <Link to={'/mobiles'} className="col-1">
            <h5 className='viewall'>View all </h5>
          </Link>
      ...
      <div class="container d-flex justify-content-center mt-3 mb-3">
        ...
        <div class="row">
          {mobiles?.map(data =>
            <Link to={'/detail'} state={data} class="col-md-4">

              <div class="card card-body mt-3">
                <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                  <div class="mr-2 mb-3 mb-lg-0">

                    <img className="phones" src={data.image} width="150" height="150" style={{objectFit:"contain"}} alt="" />

                  </div>

                  <div class="media-body">
                    <h6 class="media-title font-weight-semibold">
                      <a href="#" data-abc="true">{data.name}</a>
                    </h6>
                    ...
                    <p class="mb-3">{data["1"]}</p>
                    <p class="mb-3">{data["2"]}</p>


                  </div>

                  <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                    <h3 class="mb-0 font-weight-semibold">Rs.{data.best_price}</h3>
