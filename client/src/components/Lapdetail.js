...
const Lapdetail = () => {
  return (
    ...
    <img className="main-img" src='lap1.png' width="360" height="260" alt='laptop-img'/>
    </div>
    <h3 className='title-text'>HP i3 10th Gen 4GB</h3>
    ...
    <div className="container-fluid">
      ...
      <h4 className='phone-tit'>HP i3 10th Gen 4GB Specs</h4>
