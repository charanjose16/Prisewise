...
const Tabdetail = () => {
  return (
    ...
    <img className="main-img" src='tab3.png' width="350" height="280" alt='laptop-img'/>
    </div>
    <h3 className='title-text'>Realme Pad WiFi</h3>
    <div className='text-center price'>
      <h4 className='bprice'>Best Price   <span className='rate'>  Rs.13,999</span></h4>
    </div>
    <hr></hr>
    <div className="container-fluid">
      ...
      <div className="container-fluid">
        <div className="row brands flip">
          ...
          <div className='col-3 price-tabs'>
           <h4 className='brand-price'>Rs.16,499</h4>
          </div>
      ...
      <div className="container-fluid">
        <div className="row brands snapdeal">
          ...
          <div className='col-3 price-tabs'>
           <h4 className='brand-price'>Rs.17,199</h4>
          </div>
      ...
      <div className="container-fluid">
        <div className="row brands ebay">
          ...
          <div className='col-3 price-tabs'>
           <h4 className='brand-price'>Rs.17,900</h4>
          </div>
      ...
      <h4 className='phone-tit'>Samsung 192 Litres Refrigerator Specs</h4>
